...
function Home() {
    ...
    const { data: chatsData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "chats"
        ],
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$services$2f$chatService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchChats"]
    });
    ...
    const chats = (chatsData === null || chatsData === void 0 ? void 0 : chatsData.data) || [];
    const mutationCreateChat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$common$2f$services$2f$chatService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createChat"],
        onSuccess: {
            "Home.useMutation[mutationCreateChat]": ()=>queryClient.invalidateQueries({
                    queryKey: [
                        "chats"
                    ]
                })
        }["Home.useMutation[mutationCreateChat]"]
    });
    const createUser = ()=>{
        const newChat = {
...
_s(Home, "TOGO4BEDIvDFyIrSDsN1y9DVp/Q=", false, function() {
    return [
...
//# sourceMappingURL=_65b3ab50._.js.map